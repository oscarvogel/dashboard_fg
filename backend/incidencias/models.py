...
class IncidenciaEquipo(models.Model):
    ...
    organization_key = models.CharField(max_length=64, default="forestal-paraguay", db_index=True)
    ...
    grupo_origen_key = models.CharField(max_length=100, db_index=True)
    grupo_origen_nombre = models.CharField(max_length=150)
...
class IncidenciaPersonal(models.Model):
    ...
    abierta = models.BooleanField(default=True, db_index=True)
    finalizacion = models.DateTimeField(null=True, blank=True, db_index=True)
    cierre_source_message_id = models.CharField(max_length=191, null=True, blank=True, unique=True)
    observaciones = models.TextField(blank=True)
    creada_en = models.DateTimeField(auto_now_add=True)
    actualizada_en = models.DateTimeField(auto_now=True)
